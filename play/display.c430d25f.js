...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"ts/display/Utils.ts":[function(require,module,exports) {
"use strict";
...
exports.Utils = Utils;
},{}],"ts/display/GameState.ts":[function(require,module,exports) {
"use strict";
...
},{"./Utils":"ts/display/Utils.ts"}],"ts/display/GameOverScreen.ts":[function(require,module,exports) {
"use strict";
...
var GameOverScreen = /** @class */function (_super) {
    ...
    function GameOverScreen(ctx) {
        ...
        _this.gameOverArt = ['ooooo                  ooooo                 ', 'o                      o   o                 ', 'o     oooo ooooo oooo  o   o o   o oooo oooo', 'o  oo    o o o o o  o  o   o o   o o  o o    ', 'o   o oooo o o o oooo  o   o o   o oooo o    ', 'o   o o  o o o o o     o   o  o o  o    o    ', 'ooooo oooo o o o oooo  ooooo   o   oooo o    '];
        return _this;
    }
...
},{"./GameState":"ts/display/GameState.ts"}],"ts/display/PlayScreen.ts":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "__esModule", { value: true });
var GameOverScreen_1 = require("./GameOverScreen");
var GameState_1 = require("./GameState");
var Utils_1 = require("./Utils");
...
},{"./GameOverScreen":"ts/display/GameOverScreen.ts","./GameState":"ts/display/GameState.ts","./Utils":"ts/display/Utils.ts"}],"ts/display/CountDownScreen.ts":[function(require,module,exports) {
"use strict";
...
var CountDownScreen = /** @class */function (_super) {
    ...
    function CountDownScreen() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.numberArt = [['oooo', '   o', '   o', 'oooo', '   o', '   o', 'oooo'], ['oooo', '   o', '   o', 'oooo', 'o   ', 'o   ', 'oooo'], [' o ', 'oo ', ' o ', ' o ', ' o ', ' o ', 'ooo']];
        _this.currentArt = 0;
        _this.offset = 0;
        return _this;
    }
...
},{"./GameState":"ts/display/GameState.ts","./PlayScreen":"ts/display/PlayScreen.ts"}],"ts/display/GameContext.ts":[function(require,module,exports) {
"use strict";
...
},{"./url":"../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../node_modules/socket.io-parser/index.js","./manager":"../node_modules/socket.io-client/lib/manager.js","debug":"../node_modules/debug/src/browser.js","./socket":"../node_modules/socket.io-client/lib/socket.js"}],"ts/serverSettings.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var SERVER_ENDPOINT = 'https://watt-center-snake.herokuapp.com'; // 'localhost:3000'
exports.default = SERVER_ENDPOINT;
},{}],"ts/display/IO.ts":[function(require,module,exports) {
"use strict";
...
var IO = /** @class */function () {
    function IO() {
        this.listeners = [];
        this.socket = io.connect(serverSettings_1.default + '/display');
    }
...
exports.IO = IO;
},{"socket.io-client":"../node_modules/socket.io-client/lib/index.js","../serverSettings":"ts/serverSettings.ts"}],"img/logo.png":[function(require,module,exports) {
module.exports = "/logo.1590e67c.png";
},{}],"ts/display/StartScreen.ts":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "__esModule", { value: true });
var CountDownScreen_1 = require("./CountDownScreen");
var GameState_1 = require("./GameState");
...
var StartScreen = /** @class */function (_super) {
    ...
    function StartScreen(ctx) {
        ...
        _this.logo.src = logo_png_1.default;
...
},{"./CountDownScreen":"ts/display/CountDownScreen.ts","./GameState":"ts/display/GameState.ts","../../img/logo.png":"img/logo.png"}],"ts/display/GameRunner.ts":[function(require,module,exports) {
"use strict";
...
},{"./CountDownScreen":"ts/display/CountDownScreen.ts","./GameContext":"ts/display/GameContext.ts","./GameOverScreen":"ts/display/GameOverScreen.ts","./IO":"ts/display/IO.ts","./PlayScreen":"ts/display/PlayScreen.ts","./StartScreen":"ts/display/StartScreen.ts"}],"ts/display.tsx":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", { value: true });
var GameRunner_1 = require("./display/GameRunner");
var canvas = document.createElement('canvas');
document.body.appendChild(canvas);
var game = new GameRunner_1.GameRunner(canvas);
game.run();
},{"./display/GameRunner":"ts/display/GameRunner.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/display.tsx"], null)
//# sourceMappingURL=/display.c430d25f.map